...
import { getAllPosts, getSavedPosts, whoAmI } from "../services/ecoCommunity.services";
            ...
            <div className="h-auto min-w-full bg-maincolor ">
                ...
                <div id="content" className="h-3/4 flex justify-center items-center flex-row min-h-full relative">
                    <section className="w-1/4 flex flex-col absolute top-0 left-0 gap-6 pt-12">
                        ...
                        <button className="flex gap-0.5 pl-8 hover:text-orange-400 hover:duration-300"><span className="material-symbols-outlined">mail</span>Mensajes</button>
                    ...
                    <section className="w-1/4 flex justify-center items-center flex-col absolute right-0 top-60 gap-4 ">
                        ...
                        <button className="flex gap-1 hover:text-orange-400 hover:duration-300" ><span class="material-symbols-outlined">groups</span>Grupos</button>
