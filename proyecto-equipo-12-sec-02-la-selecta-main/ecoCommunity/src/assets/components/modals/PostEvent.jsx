          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 overflow-auto bg-white bg-opacity-20">
            ...
            <div className="flex justify-center items-center flex-row w-full ">
                <div className="flex flex-col justify-center items-start items-center w-auto gap-2 pr-4 ">
                    ...
                    <input className="w-3/4 bfile:mr-4 file:py-2 file:px-4
      file:rounded-sm file:border-2 file:h-48 file:w-full file:border-dashed file:border-white file:text-sm file:font-semibold
      file:bg-maincolor file:text-white hover:file:text-green-400 " type="file" />
