...
const CancelarPublicacion = ({close}) =>{
        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 overflow-auto bg-white bg-opacity-20">
            ...
            <div className="flex flex-col justify-center items-center bg-secondmodal-color rounded-lg p-6 w-2/6 h-auto">
              ...
              <div className="flex">
                <p className="p-2 text-modal-color text-sm text-justify">Si la eliminas, esta es una acción irreversible</p>
              </div>
              
              <div className="flex gap-2 modal-footer justify-end">
                
                <button className="bg-transparent border-2 w-28 h-10 text-modal-color rounded-md font-bold border-modal-color hover:text-white hover:bg-red-500 hover:duration-300">Eliminar</button>
