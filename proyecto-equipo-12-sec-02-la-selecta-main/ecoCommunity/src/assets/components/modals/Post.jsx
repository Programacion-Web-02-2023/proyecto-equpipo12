        ...
        <>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-100 overflow-auto bg-white bg-opacity-20">
            ...
            <div className="flex">
                ...
                <div className="flex flex-col w-3/4 gap-2 p-2">
                ...
                <textarea name="descripcion" id={"descripcion"} value={formData.descripcion} onChange={handleChange} cols="30" rows="10" className="bg-transparent border-2 rounded-xl h-32"></textarea>
